    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden z-10 transform transition-all hover:scale-[1.01] duration-500">
        ...
        <div class="p-8">
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2" for="email">Nombre de Usuario</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fa-solid fa-user text-gray-400 group-focus-within:text-blue-500 smooth-transition"></i>
                        </div>
